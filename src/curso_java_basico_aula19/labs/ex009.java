...
public class ex009 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < Array1.length; i++) {
			...
			Array3[i] = Array1[i] / Array2[i]; // Para o Array3 armazenar o resto da divisão dos números, ele precisa ser um double
		}
		...
		for (int j = 0; j <= Array1.length; j++) {
			 ...
			 System.out.println("Os valores do Array3 valem o Array1 dividido pelo Array2, posição: " + j + " valor: " + Array3[j]);
		}
	}
}
